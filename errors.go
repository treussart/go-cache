...
var (
	...
	// ErrInitCache is returned when cache initialization fails due to missing Redis and LocalCache.
	ErrInitCache = errors.New("can not init cache : Redis or LocalCache must not be nil")
